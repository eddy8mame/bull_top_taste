...
export const siteSettingsSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: "phone",   title: "Phone (display)", type: "string", group: "business",
      description: "Formatted for display, e.g. 561.653.1974" }),
    defineField({ name: "phoneDialable", title: "Phone (digits only)", type: "string", group: "business",
    ...
    defineField({
      ...
      type:        "string",
      group:       "hero",
      description: "Small pill badge above the headline, e.g. \"West Palm's #1 Jamaican Restaurant\"",
    }),
    ...
    defineField({
      ...
      type:        "string",
      group:       "branding",
      description: "Google Fonts name for headings and display text. Examples: Playfair Display · Lora · Cormorant Garamond · Merriweather · EB Garamond",
    }),
    ...
    defineField({
      ...
      type:        "string",
      group:       "branding",
      description: "Google Fonts name for body copy and UI text. Examples: Inter · Lato · Nunito · DM Sans · Open Sans · Outfit",
    }),

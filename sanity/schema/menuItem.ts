...
const modifierOptionDef = defineArrayMember({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      description:
        "Optional nested choices shown when this option is selected (e.g. Plantain → Small / Large).",
      of: [
        {
          type: "object",
...
export const menuItemSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "basics",
      description:
        "Displayed on the menu card and in the order modal. Recommended: square crop, min 600×600px.",
    ...
    defineField({
      ...
      group: "meta",
      description:
        "Total times this item has been ordered. Used to rank the Most Ordered section. Can be set manually or synced from order data.",
      initialValue: 0,
      validation: r => r.min(0).integer(),
    }),
  ],

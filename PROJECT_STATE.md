...
* **v2.6.2:**  ModifierModal validation scroll and flash repaired.
  ...
  - Scroll deferred to next animation frame to ensure ref is
  re-registered after React key remount.
  - Duplicate flash class removed from inner header div.

* **v2.6.1:**  ModifierModal UX improvements.
...
* **v2.6.0:** Fixed tax rate threading through checkout pipeline. 
